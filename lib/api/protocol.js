...
module.exports = function(Nightwatch) {
  ...
  */
  ...
  /////////////////////////////////////////////////////////////////////////////
  /**
   * Uploads a file to the remote Selenium node, returning the path to the remote file.
   *
   * @param  {string} file Full path to the local file
   * @param  {Function} callback Callback function which is called with the result. The property "value" will have the full file path for the file on the remote Selenium node
   * @returns {string}  The path to the file on the remote server
   */
  Actions.uploadFileToNode = function( filePath, callback ) {
